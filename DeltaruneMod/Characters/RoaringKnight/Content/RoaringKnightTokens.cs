...
{
    public static class RoaringKnightTokens
    {
        public static void Init()
        {
            AddRoaringKnightTokens();
        ...
        public static void AddRoaringKnightTokens()
        {
            string prefix = RoaringKnightSurvivor.ROARING_KNIGHT_PREFIX;
            ...
            Language.Add(prefix + "NAME", "Roaring Knight");
            ...
            #region Primary
            Language.Add(prefix + "PRIMARY_SLASH_NAME", "DarkSlash");
            Language.Add(prefix + "PRIMARY_SLASH_DESCRIPTION", Tokens.agilePrefix + $"Swing forward for <style=cIsDamage>{100f * RoaringKnightStaticValues.slashDamageCoefficient}% damage</style>.");
            #endregion

            #region Secondary
            Language.Add(prefix + "SECONDARY_GUN_NAME", "CrystalBarrage");
            Language.Add(prefix + "SECONDARY_GUN_DESCRIPTION", Tokens.agilePrefix + $"Fire a handgun for <style=cIsDamage>{100f * RoaringKnightStaticValues.crystalDamageCoefficient}% damage</style>.");
            #endregion

            #region Utility
            Language.Add(prefix + "UTILITY_ROLL_NAME", "ShadowlessCloak");
