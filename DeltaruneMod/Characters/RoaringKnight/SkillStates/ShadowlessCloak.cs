...
{
    public class ShadowlessCloak : BaseSkillState
    {
        public static float duration = 0.5f;
        public static float initialSpeedCoefficient = 10f;
        public static float finalSpeedCoefficient = 2.5f;

        public static string dodgeSoundString = FireRoller.lightningAttackSoundString;
        ...
        public override void OnEnter()
        {
            ...
            RoR2.Util.PlaySound(dodgeSoundString, gameObject);
