...
namespace DeltaruneMod.Interactables.SusExchange.TradingItems
{
    ...
    public class RandomTradingItem : ItemBase<RandomTradingItem>
    {
        ...
        public override string ItemFullDescription => "1 Random White or Green Item -> Chance for Upgraded Item...";
        ...
        public override Sprite ItemIcon => MainAssets.LoadAsset<Sprite>("spamton_trading_icon");
